// Instructions :
// Dans un fichier js lié répondez aux questions ci-dessous
// Dans votre fichier js précédez chaque réponse d'exercice d'un commentaire avec comme contenu le numéro de l'exercice, exemple // Exo 1
